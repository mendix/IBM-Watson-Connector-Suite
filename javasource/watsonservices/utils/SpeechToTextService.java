...
import watsonservices.proxies.AudioFormats;
...
public class SpeechToTextService {
	...
	public static IMendixObject Transcribe(IContext context, FileDocument audioFileParameter1, String username,
			String password, AudioFormats audioFormat, AudioLanguage audioLanguage) throws Exception {
	...
	private static String getAudioFormat(AudioFormats audioFormat){
		String audio = null;
        switch (audioFormat) {
	        case FLAC:
